$(document).on( 'blur', 'input' , function(){
    ...
    console.log('clicked')
    var updateUser = document.querySelector('.profile_information')
    var bIsValid = fnbIsFormValid(updateUser)
    ...
    setTimeout(function(){
       ...
       $.ajax({
        ...
        url : "api/api-users/api-user-update.php",
        method: "POST",
...
$('.delete_account').click(function(){
    ...
    $.ajax({
        ...
        url : "api/api-users/api-user-delete-account.php",
        method: "POST",
